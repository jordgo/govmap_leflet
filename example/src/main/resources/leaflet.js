...
! function(t, e, i) {
    ...
    o.GridLayer = o.Layer.extend({
            ...
            if (n) {
                ...
                if (t === i && (t = n.getCenter()), this._tileZoom !== i) {
                    ...
                    for (var d in this._tiles) {
                        ...
                        _.z === this._tileZoom && c.contains(o.point(_.y, _.x)) || (this._tiles[d].current = !1)
                    }
        ...
        _initTile: function(t) {
            ...
            t.onselectstart = o.Util.falseFn, t.onmousemove = o.Util.falseFn,
    ...
    o.TileLayer = o.GridLayer.extend({
        ...
        createTile: function(t, i) {
            ...
            o.DomEvent.on(n, "error", o.bind(this._tileOnError, this, i, n)), this.options.crossOrigin && (n.crossOrigin = ""), n.alt = "", n.setAttribute("role", "presentation"), n.src = this.getTileUrl(t), n
        },
        getTileUrl: function(t) {
            var e = {
                r: o.Browser.retina ? "@2x" : "",
                s: this._getSubdomain(t),
                x: toHex(t.x - this._getXGovMap(), 8),
                y: toHex(t.y - this._getYGovMap(), 8),
                z: addZeros(this._getZoomForUrl(), 2)
            };
        ...
        _getXGovMap: function(t) {
            var z = this._getZoomForUrl()
           if(z == 0) {return 44} else {return 57}

        },
                _getYGovMap: function(t) {
                    var z = this._getZoomForUrl()
            if(z == 0) {return 25} else {return 21}
        ...
        _getZoomForUrl: function() {
            var t = this._tileZoom,
                ...
                s = this.options.maxNativeZoom;
            return (i && (t = e - t), t += n, null !== o && t < o ? o : null !== s && t > s ? s : t) - 7
        },
